...
const MentionsLegalesPage = () => {
  return (
    <Container className="my-5">
      ...
      <div>
        <p>
          Marie FARDEL, propriétaire de Rose Charlotte & COMPAGNIE, boutique en
          ligne de vêtements et accessoires pour toute la famille.
          ...
          Marie FARDEL Rose Charlotte & COMPAGNIE est une marque déposée auprès
          de l’INPI. L'intégralité du site est la propriété exclusive de la
          microentreprise Rose Charlotte & COMPAGNIE. Aucune reproduction ou
