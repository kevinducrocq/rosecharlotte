    ...
    <Container className="my-5">
      ...
      <div className="mt-5">
        ...
        <Row className="my-5">
          <div className="row align-items-center">
            <Col md={8}>
              <h3>FABRICATION FRANÇAISE ET DE QUALITE</h3>
              <p>
                ...
                réalisation de ses créations. Travailler le Liberty, ce tissu
                anglais si célèbre, est un véritable choix. Ce tissus de grande
                qualité, incontournable de la mode, aux motifs colorés et variés
                (il n'y a pas que des fleuris!) fait l'objet de longues
                recherches pour certains! Marie vous propose en effet de très
                nombreux Liberty pour certains classiques et d'autres très
                rares. La qualité utilisée est la plus célèbre : le tana lawn,
                une batiste de coton au tissage très serré qui lui confère ce
                toucher si soyeux. La grande qualité de ce tissu fait que les
                confections conservent tout leur éclat et leurs formes même
                après de nombreux lavages. Le Liberty et les confections en
                ...
                belles matières sont toujours privilégiées. Ses créations sont
        ...
        <Row className="my-5">
          <Col>
            <h3>UN ENGAGEMENT POUR LE DEVELOPPEMENT DURABLE</h3>
            <p>
              ...
              jardin. Professeur en lycée agricole durant près de quinze années,
              elle a largement été sensibilisée à la question du développement
              durable… C’est naturellement qu’elle s’engage au travers de sa
              marque à concourir au respect de l’environnement en privilégiant
              les circuits courts, l’approvisionnement de proximité et en
              travaillant toutes les chutes de tissus que son activité génère
              pour approcher le 0 déchet. Elle a par exemple développé la
              broderie avec des appliqués en liberty pour utiliser ses plus
              petites chutes. Rien ne se perd, tout s’utilise ! Les chutes en
              surnombre sont triées. Une partie est revendue sur la boutique
              pour les liberty addicts et une autre est offerte à des
              associations pour les valoriser au profit de grandes causes.
            </p>
          </Col>
        </Row>
      </div>
