    ...
    <Container className="my-5">
      ...
      <div>
        <p>
          ...
          par la microentreprise Rose Charlotte & COMPAGNIE (ci-après dénommée
          Rose Charlotte & COMPAGNIE), représentée par Mme Marie FARDEL. Le site
          internet www.rosecharlotte.com est hébergé ……………………………. Le client
          ...
          Charlotte & COMPAGNIE (ci-après les « Conditions générales de Vente
          »). Le Site propose à la vente des vêtements et accessoires pour la
          famille personnalisables pour certains (ci-après les « Produits »)
      ...
      <div>
        ...
        <p>
          Rose Charlotte & COMPAGNIE s’efforce de proposer un accès permanent au
          Site, soit 24 heures sur 24, 7 jours sur 7. Toutefois, l'accès au Site
          peut être suspendu, à tout moment et sans préavis, notamment du fait
          de pannes, de défaillances ou de paralysie du réseau, du système et/ou
          des moyens de communication, ainsi que du fait des interventions de
          maintenance et de corrections rendues nécessaires par la mise à jour
          et le bon fonctionnement du Site. Rose Charlotte & COMPAGNIE se
          réserve en outre le droit d’effectuer, à tout moment, toutes
          modifications, suppressions et/ou ajouts sur le contenu de ce Site,
          sans préavis et de façon discrétionnaire. Le Client s'engage à ne pas
          entraver l’accès au Site et/ou le bon fonctionnement du Site de
          quelque manière que ce soit, susceptible d'endommager, d'intercepter,
          d'interférer tout ou partie du Site. Il est rappelé que le fait
          ...
          un système informatique constitue des délits passibles de sanctions
          pénales. Rose Charlotte & COMPAGNIE ne peut être tenue responsable de
          tout dommage direct ou indirect dû à une interruption, à un
          dysfonctionnement quel qu'il soit, à une suspension ou à l’arrêt du
          Site et/ou des services, et ce pour quelque raison que ce soit ou
          encore de tout dommage direct ou indirect qui résulterait d'une
          quelconque façon de l’accès au Site et/ou aux services. Le Client de
          ce Site reconnaît disposer de la compétence et des moyens nécessaires
          pour accéder et utiliser ce Site. Les protocoles de communication
          utilisés sont ceux en usage sur Internet. Rose Charlotte & COMPAGNIE
          ne saurait être tenue responsable des éléments en dehors de son
          contrôle et des dommages qui pourraient éventuellement être subis par
          l’environnement technique du Client et notamment, ses ordinateurs,
          logiciels, équipements réseaux et tout autre matériel utilisé pour
          accéder ou utiliser le Site. L’accès au Site est gratuit. Les frais
          d’accès et d’utilisation du réseau de télécommunication sont à la
          charge du Client, selon les modalités fixées par ses fournisseurs
      ...
      <div>
        ...
        <div>
          ...
          <p>
            ...
            & COMPAGNIE puisse placer de manière anonyme un ou plusieurs cookies
            en vue d’améliorer en permanence le Site notamment pour faciliter la
            gestion du Site et la reconnaissance des Clients.{' '}
          </p>
        </div>
        <div>
      ...
      <div>
        ...
        <p>
          ...
          Charlotte & COMPAGNIE se réserve également le droit de suspendre et/ou
          de refuser toute Commande d'un Client avec lequel il existerait un
          litige relatif au paiement d'une Commande antérieure, et ce quel que
          soit le mode de Commande et/ou de paiement.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          Rose Charlotte & COMPAGNIE accusera réception de la commande dès sa
          validation par l'envoi d'un courrier électronique. En cas
          ...
          qu’il fournit à Rose Charlotte & COMPAGNIE. Cette dernière ne saurait
          être tenu responsable d’éventuelles erreurs de saisie (adresse
      ...
      <div>
        ...
        <p>
          ...
          cas venait à se produire, Rose Charlotte & COMPAGNIE en informerait
          dans les plus brefs délais le client par courrier électronique ou
          téléphone et lui donnerait la possibilité de choisir un autre produit
          ou d’annuler son achat. Les Produits sont décrits et présentés avec la
          plus grande exactitude possible. Toutefois si des erreurs ou omissions
          ont pu se produire quant à cette présentation, la responsabilité de
          Rose Charlotte & COMPAGNIE ne pourrait être engagée. Compte tenu de la
          définition des écrans informatiques, les couleurs reproduites sur le
          site peuvent différer des couleurs réelles des tissus. Rose Charlotte
          & COMPAGNIE garantit l’acheteur, au titre des vices cachés pouvant
          affecter les produits livrés, dans le cadre d’un remplacement des
          produits défectueux, ou des pièces les rendant impropres à leur usage,
          ou leur remboursement sans pouvoir être considéré par l’Acheteur comme
          responsable des éventuelles conséquences dommageables que ces vices
          cachés auraient pu entraîner.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          Charlotte & COMPAGNIE 20 rue principale 62190 ECQUEDECQUES, accompagné
          du règlement par chèque libellé à l'ordre de "Rose Charlotte &
          COMPAGNIE". Toute commande payée par chèque ne sera traitée qu’à
          réception du moyen de paiement. Les délais de disponibilité comme
          d’expédition sont à recalculer à partir de la date de réception du
          moyen de paiement avec un délai de 10 jours destiné à garantir le bon
          encaissement du chèque. Les chèques sont encaissés dès validation de
          la commande. En cas d’impayé, le client sera redevable de frais de
          gestion et de frais bancaires pour un montant de 20 euros. <br />
          <br />
          ...
          Charlotte & COMPAGNIE devant être égal au montant total des achats. La
          responsabilité de Rose Charlotte & COMPAGNIE ne pourra alors en aucun
          cas être engagée.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          service clients de Rose Charlotte & COMPAGNIE 20 Rue Principale 62190
          ECQUEDECQUES, ou par e-mail adressé à
          ...
          carton) et Rose Charlotte & COMPAGNIE remboursera le client des frais
          postaux engagés en envoi simple (pas de boite postale pré-payée
          colissimo). <br /> <br />
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          sont nécessaires Rose Charlotte & COMPAGNIE, et/ou ses prestataires
          dans le cadre de la gestion de la commande du client. <br /> <br />
          Rose Charlotte & COMPAGNIE s'engage à prendre toutes les précautions
          utiles pour assurer la sécurité de ses fichiers et la protection de
          son système informatique, et empêcher notamment que les informations
          personnelles du Client soient déformées, endommagées, ou que des tiers
          non autorisés y aient accès. Les informations bancaires communiquées
          par le client lors de la finalisation de sa commande ne sont en aucun
          cas collectées par le site Rose Charlotte & COMPAGNIE. Seule la banque
          Crédit Agricole auprès de laquelle sont réalisés les paiements en
          ligne en possède une trace cryptée. Rose Charlotte & COMPAGNIE
          s’engage à ne pas communiquer ces informations nominatives à
          d’éventuels partenaires commerciaux. Seule la société Rose Charlotte &
          COMPAGNIE sera susceptible de vous adresser des offres par email ou
          courrier pour vous informer de l'existence de nos produits et
          services. <br /> <br />
      ...
      <div>
        ...
        <p>
          ...
          revanche, la responsabilité de Rose Charlotte & COMPAGNIE ne pourra
          être engagée dans le cas où l'inexécution de ses obligations serait
          imputable soit au fait imprévisible et insurmontable d'un tiers au
          contrat soit à un cas de force majeure telle que définie par la
          ...
          Charlotte & COMPAGNIE en avisera l'utilisateur/acheteur dans les cinq
          (5) jours ouvrables suivant la survenance ou la menace de cet
          événement. <br />
          ...
          Charlotte & COMPAGNIE pourra ne pas honorer la commande, à charge pour
          elle de rembourser l'acheteur le cas échéant. <br /> <br />
        </p>
      </div>
      <div>
        ...
        <p>
          ...
          cas, Rose Charlotte & COMPAGNIE ne donne de garantie de conformité à
          la législation locale qui vous serait applicable, dès lors que vous
